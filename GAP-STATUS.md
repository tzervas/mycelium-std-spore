# Gap status — `mycelium-std-spore`

| Field | Value |
|-------|--------|
| **Component** | `mycelium-std-spore` |
| **Role** | std.spore library surface |
| **Date** | 2026-07-29 |
...
| **Native twin** | `tzervas/mycelium-std-spore-myc` under [mycelium-lang-myc](https://github.com/tzervas/mycelium-lang-myc) |
| **Local gap notes** | none |
| **Related issues** | Package model ready; publish UX residual |
